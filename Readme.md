...
To see the result, you can just run "EffectofBellmanFordProtocolForLargeNetworks.m" script with sample simplex arrays and check the final results in console.
